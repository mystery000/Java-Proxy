...
**EosProxyServer** is the **FULL-FUNCTIONAL** backend server of PocketEOS.
...
This project is the full-funcional backend server for (https://github.com/mystery000/Java-Proxy)
...
>`git clone https://github.com/mystery000/Java-Proxy.git`
...
![](https://github.com/mystery000/Java-Proxy.git/master/screenshots/get_info.png)
...
3.In the CONTRACT layer, you can standardize a general error code specification in your contract code. Then you can catch the contract error code with a parser.
